/**
 * Function: main
 * Description: Entry point for the word indexing program. Manages user interactions through a menu-driven system.
 * Input: argc - argument count, argv - argument values (file names).
 * Output: Executes user-selected operations like creating, displaying, searching, saving, and updating the database.
 */
